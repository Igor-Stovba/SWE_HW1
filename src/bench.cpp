...
using Graph_ = std::vector<std::vector<std::pair<int, long long>>>; // first = to, second = weight

// graph generation
Graph_ generate_random_graph(int num_nodes, int num_edges, int min_weight, int max_weight) {
